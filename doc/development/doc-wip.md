...
* Development pages: audit the remaining coding, Windows/MinGW, NSIS, and VC
  pages against the maintained developer docs and current source. Fold only
  material that still describes current workflow or internals.
