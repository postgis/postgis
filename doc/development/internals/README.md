# Internals and PostgreSQL C API Notes

This page collects implementation notes for C code that crosses the PostgreSQL
extension boundary. It was consolidated from the Trac developer wiki coding
notes and should be updated when internal memory or serialization conventions
change.
