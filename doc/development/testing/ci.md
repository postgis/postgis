...
The existing `utils/ci-trac-line.sh` helper can seed Trac badge rows, but a
maintained repository copy of the inventory should also be checked or
regenerated by script. Until that checker exists, keep the Trac badge table as
a live operational dashboard rather than treating it as authoritative
