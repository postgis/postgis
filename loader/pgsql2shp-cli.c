...
main(int argc, char **argv)
{
	...
	/*
	 * Determine the database name from the next argument, if no
	 * database, exit.
	 */
	if (pgis_optind < argc) {
	...
	/*
	 * Determine the table and schema names from the next argument if
	 * supplied, otherwise if it's a user-defined query then set that
	 * instead
	 */
	if (pgis_optind < argc) {
