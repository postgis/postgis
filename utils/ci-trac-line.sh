...
|| [[Image(https://woodie.osgeo.org/api/badges/postgis/postgis/status.svg?branch=stable-${VER}, link=https://woodie.osgeo.org/postgis/postgis/branches/stable-${VER}, alt=status)]] || \\
