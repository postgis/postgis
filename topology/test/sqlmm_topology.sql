...
-- ST_AddIsoEdge non-isolated nodes (TODO req. AddIsoEdge to complete)

-- ST_AddIsoEdge nodes on different faces (TODO req. nodes contained in face)
...
SELECT topology.ST_AddIsoEdge('sqlmm_topology', 1, 2, 'LINESTRING(0 0, 2 1, 10 0)');
