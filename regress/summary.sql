...
SELECT 'T1B', ST_Summary(addbbox('POINT(0 0)'::geometry));
...
SELECT 'T1ZMB', ST_Summary(addbbox('POINT(0 0 0 0)'::geometry));
SELECT 'T1ZMBS', ST_Summary(addbbox('SRID=4326;POINT(0 0 0 0)'::geometry));
