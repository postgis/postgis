...
SELECT '#5347.union-empty-first', ST_Union('0101000020E6100000000000000000F07F000000000000F07F'::geography, 'POINT EMPTY'::geography);
SELECT '#5347.union-empty-second', ST_Union('POINT EMPTY'::geography, '0101000020E6100000000000000000F07F000000000000F07F'::geography);
SELECT '#5347.difference-empty', ST_Difference('0101000020E6100000000000000000F07F000000000000F07F'::geography, 'POINT EMPTY'::geography);
