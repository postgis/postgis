...
SELECT 56, ST_AsEWKT(ST_GeomFromText('NURBSCURVE(DEGREE 2, CONTROLPOINTS (NURBSPOINT(WEIGHTEDPOINT M (0 0 0), WEIGHT 1), NURBSPOINT(WEIGHTEDPOINT M (5 10 1800), WEIGHT 1), NURBSPOINT(WEIGHTEDPOINT M (10 0 3600), WEIGHT 1)), KNOTS (KNOT(0,3), KNOT(1,3)))'));
SELECT 57, ST_AsText(ST_GeomFromText('NURBSCURVE(1, (0 0, 10 10), (1, 1), (0, 0, 1, 1))'));
SELECT 58, ST_AsText(ST_GeomFromText('NURBSCURVE(2, (0 0, 5 10, 10 0), (1, 2, 1), (0, 0, 0, 1, 1, 1))'));
SELECT 59, ST_AsText(ST_GeomFromText('NURBSCURVE Z(3, (0 0 0, 3 10 3, 7 10 7, 10 0 10), (1, 1.5, 1.5, 1), (0, 0, 0, 0, 1, 1, 1, 1))'));
SELECT 60, ST_GeomFromText('NURBSCURVE(DEGREE 2, CONTROLPOINTS (NURBSPOINT(WEIGHTEDPOINT(0 0), WEIGHT 1), NURBSPOINT(WEIGHTEDPOINT(5 10), WEIGHT 1), NURBSPOINT(WEIGHTEDPOINT(10 0), WEIGHT 1)), KNOTS (KNOT(0,10001)))');
SELECT 61, ST_GeomFromText('NURBSCURVE(DEGREE 2, CONTROLPOINTS (NURBSPOINT(WEIGHTEDPOINT(0 0), WEIGHT 1), NURBSPOINT(WEIGHTEDPOINT(5 10), WEIGHT 1), NURBSPOINT(WEIGHTEDPOINT(10 0), WEIGHT 1)), KNOTS (KNOT(0,6000), KNOT(1,6000)))');
