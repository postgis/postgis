...
-- Short inputs may safely use more than 10000 segments when the generated output
-- remains below the per-call point cap.
SELECT '12', ST_NPoints(ST_CatmullRomSmoothing('LINESTRING(0 0, 1 0, 2 0, 3 0)', 10001));
