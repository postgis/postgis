...
*/
int
spheroid_project(const GEOGRAPHIC_POINT * r, const SPHEROID * spheroid, double distance, double azimuth, GEOGRAPHIC_POINT * g)
{
	struct geod_geodesic gd;
	geod_init(&gd, spheroid->a, spheroid->f);
...
spheroid_distance(const GEOGRAPHIC_POINT * a, const GEOGRAPHIC_POINT * b, const SPHEROID * spheroid)
{
	...
	double		sigma, sin_sigma, cos_sigma, cos2_sigma_m, sqrsin_sigma,
			last_lambda, omega;
...
spheroid_direction(const GEOGRAPHIC_POINT * r, const GEOGRAPHIC_POINT * s, const SPHEROID * spheroid)
{
	...
	double		omega = lambda;
	double		alpha, sigma, sin_sigma, cos_sigma, cos2_sigma_m,
			sqr_sin_sigma, last_lambda;
...
*/
static double
spheroid_boundingbox_area(const GEOGRAPHIC_POINT * southWestCorner, const GEOGRAPHIC_POINT * northEastCorner, const SPHEROID * spheroid)
{
...
ptarray_area_spheroid(const POINTARRAY * pa, const SPHEROID * spheroid)
{
	...
	/*
	 * Geodetic bbox < 0.0 implies geometry is entirely in southern
	 * hemisphere
	 */
	if (gbox2d.ymax < 0.0)
		in_south = LW_TRUE;
