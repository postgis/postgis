...
/*
 * this will change to NaN when I figure out how to get NaN in a
...
#define OUT_MAX_DIGS_DOUBLE (OUT_SHOW_DIGS_DOUBLE + 2)	/* +2 mean add dot and
							 * sign */
...
/*
 * The possible ways a pair of segments can interact. Returned by
...
/*
 * Generate an interpolated coordinate p given an interpolation value and
 * ordinate to apply it to
 */
...
/*
 * Support for in place modification of point arrays, fast function to move
 * coordinate values around
 */
...
/*
 * Write into *ret the coordinates of the closest point on segment A-B to the
 * reference input point R
 */
...
/*
 * What side of the line formed by p1 and p2 does q fall? Returns -1 for left
 * and 1 for right and 0 for co-linearity
 */
