...
* Force dims
*/
LWGEOM* lwgeom_force_dims(const LWGEOM *lwgeom, int hasz, int hasm, double defaultz, double defaultm);
LWPOINT* lwpoint_force_dims(const LWPOINT *lwpoint, int hasz, int hasm, double defaultz, double defaultm);
LWLINE* lwline_force_dims(const LWLINE *lwline, int hasz, int hasm, double defaultz, double defaultm);
LWPOLY* lwpoly_force_dims(const LWPOLY *lwpoly, int hasz, int hasm, double defaultz, double defaultm);
LWCOLLECTION* lwcollection_force_dims(const LWCOLLECTION *lwcol, int hasz, int hasm, double defaultz, double defaultm);
POINTARRAY* ptarray_force_dims(const POINTARRAY *pa, int hasz, int hasm, double defaultz, double defaultm);
