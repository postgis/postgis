...
out_geojson_test_precision(void)
{
	...
	/* small numbers */
	/*
	 * NOTE: precision of 300 will be converted to max precision (15) and
	 * being there no significant digit within that range only zeroes
	 * will be returned See
	 * http://trac.osgeo.org/postgis/ticket/2051#comment:11
	 */
