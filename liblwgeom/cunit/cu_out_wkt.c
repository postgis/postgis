...
static void test_wkt_out_point(void)
{
	...
	/* Test big numbers */
	printf("%s\n", cu_wkt("POINT(-123456789012345.12345678 -1234567890123458.12345678)", WKT_ISO));
	CU_ASSERT_STRING_EQUAL(cu_wkt("POINT(-123456789012345.12345678 -1234567890123458.12345678)", WKT_ISO),
							"POINT(-123456789012345 -1.23457e+15)");
	CU_ASSERT_STRING_EQUAL(cu_wkt(
		"POINT( " \
	    "9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999 " \
	    "0.000000000000000000000000000001)",WKT_ISO), "POINT(1e+100 0)");
	printf("%s\n", cu_wkt(
		"POINT( " \
	    "9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999 " \
	    "0.000000000000000000000000000001)",WKT_ISO));
