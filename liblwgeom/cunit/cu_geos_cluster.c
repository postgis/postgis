...
static void
perform_cluster_within_distance_test(double tolerance, char **wkt_inputs, uint32_t num_inputs, char **wkt_outputs, uint32_t num_outputs)
{
	LWGEOM	      **lw_results;
	uint32_t	num_clusters;
...
dbscan_test(void)
{
	...
	/*
	 * Although POINT (1 0) and POINT (2 0) are within eps distance of
	 * each other, they do not connect the two clusters because POINT (1
	 * 0) is not a core point. See #3572
	 */
	test.eps = 1.01;
	test.min_points = 5;
