...
static void in_encoded_polyline_test_geoms(void)
{
	do_encoded_polyline_test(
	    "_p~iF~ps|U_ulLnnqC_mqNvxq`@", 5, "SRID=4326;LINESTRING(-120.2 38.5,-120.95 40.7,-126.45 43.252)");
}
...
static void in_encoded_polyline_test_precision(void)
{
	do_encoded_polyline_test(
	    ...
	    6,
	    "SRID=4326;LINESTRING(-0.250691 49.283,-0.250633 49.2834,-0.250502 49.284,-0.251245 49.284,-0.251938 49.2842,-0.251938 49.2842)");
}
