...
/*
 * TODO: change lwgeom_same to lwgeom_equals (requires porting predicates to
 * liblwgeom)
 */
...
test_lwgeom_make_valid(void)
{
	...
	/*
	 * We're really only interested in avoiding a crash in here. See
	 * http://trac.osgeo.org/postgis/ticket/1738 TODO: enhance the test
	 * if we find a workaround to the excepion: See
	 ...
	 * 0),MULTIPOLYGON(((5 5,0 0,0 10,5 5)),((5 5,10 10,10 0,5
	 * 5))),LINESTRING(10 0,10 10))");
	 */
