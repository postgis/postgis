...
test_mindistance2d_tolerance(void)
{
	...
	/*
	 * * Geometry Collection Collection Multipoint vs Geometry Collection
...
test_lwgeom_locate_along(void)
{
	...
	/*
	 * ST_Locatealong(ST_GeomFromText('MULTILINESTRING M ((1 2 3, 5 4 5),
	 * (50 50 1, 60 60 200))'), 105)
	 */
...
{
	/*
	 * int lw_dist2d_pt_arc(const POINT2D* P, const POINT2D* A1, const
	 * POINT2D* A2, const POINT2D* A3, DISTPTS* dl)
	 */
	DISTPTS		dl;
	POINT2D		P, A1, A2, A3;
	int		rv;
...
{
	/*
	 * int lw_dist2d_seg_arc(const POINT2D *A1, const POINT2D *A2, const
	 * POINT2D *B1, const POINT2D *B2, const POINT2D *B3, DISTPTS *dl)
	 */
...
{
	/*
	 * lw_dist2d_arc_arc(const POINT2D *A1, const POINT2D *A2, const
	 * POINT2D *A3, const POINT2D *B1, const POINT2D *B2, const POINT2D
	 * *B3, DISTPTS *dl)
	 */
	DISTPTS		dl;
...
{
	/*
	 * double lw_arc_length(const POINT2D *A1, const POINT2D *A2, const
	 * POINT2D *A3)
	 */
...
{
	/*
	 * lw_dist2d_pt_ptarrayarc(const POINT2D *p, const POINTARRAY *pa,
	 * DISTPTS *dl)
	 */
	DISTPTS		dl;
	int		rv;
...
{
	/*
	 * int lw_dist2d_ptarray_ptarrayarc(const POINTARRAY *pa, const
	 * POINTARRAY *pb, DISTPTS *dl)
	 */
	DISTPTS		dl;
	int		rv;
	LWLINE	       *lwline1;
...
test_lwgeom_tcpa(void)
{
	...
	/*
	 * One of the tracks is still, the other passes at 10 meters from
	 * point
	 */
	...
	/*
	 * Parallel tracks, different speed (g2 gets closer as time passes),
	 * 2d
	 */
	...
	/*
	 * Parallel tracks, different speed (g2 left behind as time passes),
	 * 2d
	 */
