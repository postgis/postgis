...
typedef struct {
	...
	uint8_t		magic_byte;	/* the magic byte contain info about
					 * if twkb contain id, size info,
					 * bboxes and precision */

	int		ndims;	/* Number of dimensions */

	int64_t	       *coords;	/* An array to keep delta values from 4
				 * dimensions */
