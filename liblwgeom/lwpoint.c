...
/*
 * Convenience functions to hide the POINTARRAY TODO: obsolete this
 */
int
...
/*
 * Construct a new point.  point will not be copied use SRID=SRID_UNKNOWN for
 * unknown SRID (will have 8bit type's S = 0)
 */
LWPOINT	       *
