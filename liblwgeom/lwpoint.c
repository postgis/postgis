...
LWPOINT*
lwpoint_force_dims(const LWPOINT *point, int hasz, int hasm, double defaultz, double defaultm)
{
	...
	else
	{
		...
		pdims = ptarray_force_dims(point->point, hasz, hasm, defaultz, defaultm);
