...
static void
add_value_as_string(mvt_agg_context * ctx,
...
static void
parse_datum_as_string(mvt_agg_context * ctx, Oid typoid,
 ...
 */
LWGEOM	       *
mvt_geom(LWGEOM * lwgeom, const GBOX * gbox, uint32_t extent, uint32_t buffer,
	 bool clip_geom)
{
	AFFINE		affine;
	gridspec	grid;
