...
POSTGIS_DEPRECATE("1.2.3", LWGEOM_asBinary)
POSTGIS_DEPRECATE("1.2.3", LWGEOM_asText)
POSTGIS_DEPRECATE("1.2.3", LWGEOM_ndims)
POSTGIS_DEPRECATE("1.2.3", LWGEOM_set_srid)
POSTGIS_DEPRECATE("1.2.3", LWGEOM_get_srid)
