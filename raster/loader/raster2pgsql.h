...
/*
 * max length of of "name" data type in PostgreSQL as defined in
 * pg_config_manual.h as macro NAMEDATALEN default is 64 bytes (63 usable
...
/*
 * maximum tile size based upon maximum field size as defined for PostgreSQl
