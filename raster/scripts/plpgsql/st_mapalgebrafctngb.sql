            ...
            FOR y in array_lower(matrix, 2)..array_upper(matrix, 2) LOOP
                IF matrix[x][y] IS NULL THEN
                    CASE nodatamode
                        ...
                        WHEN 'ignore' THEN
                            matrix[x][y] := 0;
                        ELSE -- if the nodatamode was 'value', it was already substituted in the main ST_MapAlgebraFctNgb call.
                             -- otherwise, this is a literal value that should replace this nodata value
