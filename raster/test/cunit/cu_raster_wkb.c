 ...
 * <bkpark@ucdavis.edu> Copyright (C) 2009  Sandro Santilli <strk@kbt.io>
 *
...
test_raster_wkb()
{
	...
	/*
	 * printf(" in hexwkb len: %d\n", strlen(hexwkb)); printf("out hexwkb
	 * len: %d\n", len); printf(" in hexwkb: %s\n", hexwkb); printf("out
	 * hexwkb: %s\n", out);
	 */
	CU_ASSERT_EQUAL(len, strlen(hexwkb));
	/*
	 * would depend on machine endian... CU_ASSERT_STRING_EQUAL(hexwkb,
	 * out);
	 */
	...
	hexwkb =
		...
		"40"		/* First band type (1BB, in memory,
				 * hasnodata) */
		"00"		/* nodata value (0) */
		"01"		/* pix(0,0) == 1 */
		;
	...
	hexwkb =
		...
		"43"		/* First band type (8BSI, in memory,
				 * hasnodata) */
		"FF"		/* nodata value (-1) */
		"FF"		/* pix(0,0) == -1 */
		"00"		/* pix(1,0) ==  0 */
	...
	hexwkb =
		...
		"0003"		/* width (uint16 3) */
		"0002"		/* height (uint16 2) */
		"C5"		/* First band type (16BSI, on disk,
				 * hasnodata) */
		"FFFF"		/* nodata value (-1) */
		"03"		/* ext band num == 3 */
	...
	hexwkb =
		...
		"0300"		/* width (uint16 3) */
		"0100"		/* height (uint16 1) */
		"45"		/* First band type (16BSI, in memory,
				 * hasnodata) */
		"0100"		/* nodata value (1) */
		"0100"		/* pix(0,0) == 1 */
		"B401"		/* pix(1,0) == 436 */
	...
	for (i = 0; i < 5; ++i) {
		...
		hexwkb =
			...
			"000000E02B274A41"	/* ipX (float64
						 * 3427927.750000) */
			"0000000077195641"	/* ipY (float64
						 * 5793244.000000) */
