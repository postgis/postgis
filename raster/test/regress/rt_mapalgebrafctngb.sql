...
SELECT ST_MapAlgebraFctNgb(NULL, 1, NULL, 1, 1, 'ST_Sum(float[][], text, text[])'::regprocedure, 'NULL', NULL) IS NULL FROM ST_TestRaster(0, 0, -1) rast;
...
SELECT 
 ...
 FROM ST_SetBandNoDataValue(ST_TestRaster(3, 3, 1), 1, NULL) AS rast;
