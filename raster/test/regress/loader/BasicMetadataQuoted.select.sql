SELECT count(*), pg_typeof("rast""col")::text, pg_typeof("file""col")::text, pg_typeof("bad""col")::text FROM loadedrast GROUP BY pg_typeof("rast""col")::text, pg_typeof("file""col")::text, pg_typeof("bad""col")::text;
SELECT
	"file""col" = 'Metadata.tif',
