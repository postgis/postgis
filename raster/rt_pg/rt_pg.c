 ...
 *
 * Copyright (C) 2009-2010  Sandro Santilli <strk@keybit.net>, David Zwarg <dzwarg@avencia.com>, 
 * Pierre Racine <pierre.racine@sbf.ulaval.ca>, Jorge Arevalo <jorge.arevalo@deimos-space.com>
 *
