...
/*
 * determine if the two rasters are within the specified distance of each
 * other
 */
Datum		RASTER_dwithin(PG_FUNCTION_ARGS);

/*
 * determine if the two rasters are fully within the specified distance of
 * each other
 */
...
Datum
RASTER_intersects(PG_FUNCTION_ARGS)
{
...
Datum
RASTER_overlaps(PG_FUNCTION_ARGS)
{
	const		uint32_t set_count = 2;
	rt_pgraster    *pgrast[2];
	int		pgrastpos[2] = {-1, -1};
...
Datum
RASTER_touches(PG_FUNCTION_ARGS)
{
	const		uint32_t set_count = 2;
	rt_pgraster    *pgrast[2];
	int		pgrastpos[2] = {-1, -1};
...
Datum
RASTER_contains(PG_FUNCTION_ARGS)
{
	const		uint32_t set_count = 2;
	rt_pgraster    *pgrast[2];
	int		pgrastpos[2] = {-1, -1};
...
Datum
RASTER_containsProperly(PG_FUNCTION_ARGS)
{
	const		uint32_t set_count = 2;
	rt_pgraster    *pgrast[2];
	int		pgrastpos[2] = {-1, -1};
...
Datum
RASTER_covers(PG_FUNCTION_ARGS)
{
	const		uint32_t set_count = 2;
	rt_pgraster    *pgrast[2];
	int		pgrastpos[2] = {-1, -1};
...
Datum
RASTER_coveredby(PG_FUNCTION_ARGS)
{
	const		uint32_t set_count = 2;
	rt_pgraster    *pgrast[2];
	int		pgrastpos[2] = {-1, -1};
...
Datum
RASTER_dwithin(PG_FUNCTION_ARGS)
{
	const		uint32_t set_count = 2;
	rt_pgraster    *pgrast[2];
	int		pgrastpos[2] = {-1, -1};
...
Datum
RASTER_dfullywithin(PG_FUNCTION_ARGS)
{
	const		uint32_t set_count = 2;
	rt_pgraster    *pgrast[2];
	int		pgrastpos[2] = {-1, -1};
...
Datum
RASTER_sameAlignment(PG_FUNCTION_ARGS)
{
	const		uint32_t set_count = 2;
	rt_pgraster    *pgrast[2];
	int		pgrastpos[2] = {-1, -1};
...
Datum
RASTER_notSameAlignmentReason(PG_FUNCTION_ARGS)
{
	const		uint32_t set_count = 2;
	rt_pgraster    *pgrast[2];
	int		pgrastpos[2] = {-1, -1};
