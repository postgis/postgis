...
/*
 * from PgSQL utils/elog.h, LOG is 15, and DEBUG5 is 10 and everything else
 * is in between
 */
...
/*
 * GUC name search functions stolen from PostgreSQL to support searching for
 * already-defined GUC variables
 */
...
/*
 * For PostgreSQL >= 8.5 redefine the STATRELATT macro to its new value of
 * STATRELATTINH
 */
